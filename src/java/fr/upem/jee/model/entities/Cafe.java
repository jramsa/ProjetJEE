...
public class Cafe implements Serializable {
    ...
    public Cafe(Integer id, Date date, String cafeName, String address, String district, BigDecimal counterPrice, BigDecimal indoorPrice, BigDecimal outdoorPrice, Object coord) {
        this.id = id;
        this.date = date;
